...
SECRET_KEY = 'django-insecure-#=945lrnqbkgwhb$t39!g8@4!$^&br9dvls3aywvghr0-^-ze)'
...
INSTALLED_APPS = [
    ...
    'applications.authentication.apps.AuthAppConfig',
    'applications.account.apps.AccountAppConfig',
]
